...
import nextJs from "../../files/icons/script-icon/icons8-nextjs-128.png";
                ...
                <main id="main-home">
                    ...
                    <div className="info">
                        ...
                        <div className="btns">
                            ...
                            <a href="https://drive.google.com/file/d/1ZLsXHxVpR1isn0Vx9NnG92oY5GJT3xAG/view?usp=drive_link" download>
                            Download CV
                            </a> 
                            <Link to="/contact">
                            Contact
                    ...
                    <div className="div-lang">
                        ...
                        <div><a href="https://en.wikipedia.org/wiki/Next.js" ><img className="img-lang" src={nextJs} alt="nextJs" /></a><h2>NextJs</h2></div>
                        <div><a href="https://en.wikipedia.org/wiki/React_(software)" ><img className="img-lang" src={reactIcon} alt="ReactJs" /></a><h2>ReactJs</h2></div>
